...
<script>
import bar from 'c3/src/component/c3-bar.js'
import defaultConfig from '../line/config.js'
...
export default {
  ...
  computed: {
    option () {
      ...
      if (!configCopy.data.type) configCopy.data.type = 'bar'
  ...
  mounted () {
    ...
    chart = bar.generate(this.option)
  },
